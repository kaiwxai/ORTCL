...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_attention',  default=1, help='whether to output attention in ecoder')
    ...
    parser.add_argument('--devices', type=str, default='1,2,3,4', help='device ids of multile gpus')
    ...
    parser.add_argument('--win_sum', type=int, default=5, help='mask ratio')
    parser.add_argument('--windons', type=int, default=1, help='mask ratio')
    ...
    with HiddenPrints(int(os.environ.get("LOCAL_RANK", "0"))):
        ...
        if args.is_finetuning:
            for ii in range(args.itr):
                ...
                for windows in [2, 3, 4, 5]:
                    print('>>>>>>>start finediting : {}>>>>>>>>>>>>>>>>>>>>>>>>>>'.format(setting))
